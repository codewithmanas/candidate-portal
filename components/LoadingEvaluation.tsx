...
export default function LoadingEvaluation({status}: { status : string}) {
  ...
  return (
    ...
    <Card className="p-6 sm:p-8 md:p-10 max-w-3xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <div
                className={`flex items-center gap-4 p-4 rounded-lg transition-colors bg-primary/5 dark:bg-primary/10`}
              >
                <div className={`relative rounded-full p-2 bg-primary/10 text-primary dark:bg-primary/20 dark:text-primary-foreground `}>
                  <StepBackIcon className="h-5 w-5 sm:h-6 sm:w-6" />
                  { (
